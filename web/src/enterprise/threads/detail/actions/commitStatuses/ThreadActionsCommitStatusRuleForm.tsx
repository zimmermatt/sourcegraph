...
export const ThreadActionsCommitStatusRuleForm: React.FunctionComponent<Props> = ({
    ...
    return (
        <Form className="form" onSubmit={onSubmit}>
            ...
            <div className="form-group">
                <label htmlFor="thread-pull-request-template-edit-form__description">Pull request description</label>
                <textarea
                    className="form-control"
                ...
                />
                <small id="thread-pull-request-template-edit-form__description-help" className="form-text text-muted">
                    Template variables:{' '}
